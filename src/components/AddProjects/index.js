...
import {uploadedOrder,historyOrder,inventoryOrder,projectOrder} from "../../testData/order"
	  ...
	  <div>
		  <Modal
             ...
             <div style={{marginBottom:10,display:"flex",justifyContent:"space-between"}}>
                ...
                <div> 
					<button className="buttonModalCables" onClick={() => submitProject()}>Save</button>
					</div>
...
/> 
     ...
     <div className="innerDiv">
      ...
      <table className="table">
        ...
        <tbody>
          {projects.sort((a, b) => a.PROJECT_NAME.localeCompare(b.PROJECT_NAME)).slice((page-1)*6,(page-1)*6 + 6).map(item => (
            <tr>
              <td>
                {item.PROJECT_NAME}
              </td>
