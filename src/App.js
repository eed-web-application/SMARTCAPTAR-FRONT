...
function App() {
  ...
  return (
    <BrowserRouter baseline=“/smartcaptar“ >
      <Routes>
        <Route
          path="/"
          element={
            <PrivateRoute auth={{ isAuthenticated: user ? true : false }}>
        ...
        />
        <Route
          path="/cable-inventory"
          element={
            <PrivateRoute auth={{ isAuthenticated: user ? true : false }}>
              <CableInventory setUser={setUser} user={user} />
            </PrivateRoute>
          }
        />
        <Route
          path="/uploaded-cables"
          element={
            <PrivateRoute auth={{ isAuthenticated: user ? true : false }}>
              <UploadedCables setUser={setUser} user={user} />
            </PrivateRoute>
          }
        />
        <Route
          path="/approved-cables"
          element={
            <PrivateRoute auth={{ isAuthenticated: user ? true : false }}>
              <ApprovedCables setUser={setUser} user={user} />
            </PrivateRoute>
          }
        />
        <Route
          ...
          element={
            <PrivateRoute auth={{ isAuthenticated: user ? true : false }}>
              <CableHistory setUser={setUser} user={user} />
            </PrivateRoute>
          }
        />
        <Route
          ...
          element={
            <PrivateRoute auth={{ isAuthenticated: user ? true : false }}>
              <CreateNew setUser={setUser} user={user} />
            </PrivateRoute>
          }
        />
        <Route
          ...
          element={
            <PrivateRoute auth={{ isAuthenticated: user ? true : false }}>
              <SentItems setUser={setUser} user={user} />
            </PrivateRoute>
          }
        />
        <Route
          ...
          element={
            <PrivateRoute auth={{ isAuthenticated: user ? true : false }}>
              <Projects setUser={setUser} user={user} />
            </PrivateRoute>
          }
        />
        <Route
          path="/Settings"
          element={
            <PrivateAdminRoute auth={{ isAuthenticated: user ? true : false }}>
